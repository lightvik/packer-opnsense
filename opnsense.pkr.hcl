...
source "qemu" "opnsense" {
  ...
  disk_size        = "30G"              # Размер виртуального диска
  ...
  boot_command = [
    ...
    "<enter>",
    "<wait2s>",
    # Главное меню: три стрелки вниз до пункта «Import config», Enter
    "<down><down><down><enter>",
    "<wait2s>",
    # Выбор носителя с конфигом: два раза вниз (sr1 — второй CD-ROM), Enter
    "<down><down><enter>",
    "<wait2s>",
